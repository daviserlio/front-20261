...
function Faltas() {
  return (
    <main className="flex-1 p-6 md:p-10 bg-white min-h-screen">
      <Topbar />
      <h2 className="text-3xl md:text-5xl font-bold mb-4">Minhas Faltas</h2>
          ...
          <table className="w-full text-center">
            <thead>
              <tr className="border-b border-[#ccc] font-bold">
                ...
                <th className="p-4">Total de Faltas</th>
                <th className="p-4">% de Presença</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="border-b border-[#eee]">
                <td className="p-4 text-left">Manutenção de Software e Devops</td>
                <td>0</td><td>100%</td>
              </tr>
            </tbody>
          </table>
